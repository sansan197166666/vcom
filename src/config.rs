...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("连信宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.75.194"];
pub const RS_PUB_KEY: &str = "Ukufd4gwmBI7uqVbV8HrPUBwFP7Dgtgh40wwR70MJ8g=";
pub const RENDEZVOUS_PORT: i32 = 36616;
pub const RELAY_PORT: i32 = 36617;
pub const WS_RENDEZVOUS_PORT: i32 =36618;
pub const WS_RELAY_PORT: i32 = 36619;
