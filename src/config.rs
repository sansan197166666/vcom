...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("简义会".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.199"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 40056;
pub const RELAY_PORT: i32 = 40057;
pub const WS_RENDEZVOUS_PORT: i32 =40058;
pub const WS_RELAY_PORT: i32 = 40059;
