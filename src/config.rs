...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("快议联".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.170"];
pub const RS_PUB_KEY: &str = "39iCJusN1Mh+H7OqXB8i10yeRlfG2ytJbtBN5y3CQhM=";
pub const RENDEZVOUS_PORT: i32 = 39946;
pub const RELAY_PORT: i32 = 39947;
pub const WS_RENDEZVOUS_PORT: i32 =39948;
pub const WS_RELAY_PORT: i32 = 39949;
