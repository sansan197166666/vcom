...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.66.124"];
pub const RS_PUB_KEY: &str = "HTmpUiK+fs6IUeKUXNkCRiIX39MxlQlIMUuiOjBDmOY=";
pub const RENDEZVOUS_PORT: i32 = 58846;
pub const RELAY_PORT: i32 = 58847;
pub const WS_RENDEZVOUS_PORT: i32 =58848;
pub const WS_RELAY_PORT: i32 = 58849;
