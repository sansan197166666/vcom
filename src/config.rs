...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("快意连".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.150"];
pub const RS_PUB_KEY: &str = "VqTD0sKiB4tnASmqSnoqSuR4yXm1SZS2i2q88x6HYGg=";
pub const RENDEZVOUS_PORT: i32 = 39906;
pub const RELAY_PORT: i32 = 39907;
pub const WS_RENDEZVOUS_PORT: i32 =39908;
pub const WS_RELAY_PORT: i32 = 39909;
