...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.77.95"];
pub const RS_PUB_KEY: &str = "M940FPE9B7UxHOSnojtJA9AZk6rQzBU5nKCXlHAdMTQ=";
pub const RENDEZVOUS_PORT: i32 = 56636;
pub const RELAY_PORT: i32 = 56637;
pub const WS_RENDEZVOUS_PORT: i32 =56638;
pub const WS_RELAY_PORT: i32 = 56639;
