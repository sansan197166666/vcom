...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("直议通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.77.50"];
pub const RS_PUB_KEY: &str = "4+PHkM+fhyqfQ56u3UZpuaxsckXM37iPZpBDMkYxPXc=";
pub const RENDEZVOUS_PORT: i32 = 55446;
pub const RELAY_PORT: i32 = 55447;
pub const WS_RENDEZVOUS_PORT: i32 =55448;
pub const WS_RELAY_PORT: i32 = 55449;
